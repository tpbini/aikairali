...
$online_event     = get_field( 'online_event' );
			...
			<main>
				...
				<div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; margin: 32px 0;">
					...
					<h2 style="font-size: 1.75rem; font-weight: 800; color: #0f172a; margin: 0 0 20px 0;">
						<?php echo esc_html( $ticket_price ? 'Ticket: ' . $ticket_price : 'Free Registration' ); ?>
					</h2>
					...
					<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px 24px; font-size: 0.925rem;">
						...
						<div style="display: flex; justify-content: space-between; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px;">
							...
							<strong><?php echo esc_html( $event_date ); ?></strong>
						</div>
						<?php endif; ?>
						...
						<div style="display: flex; justify-content: space-between; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px;">
							...
							<strong><?php echo esc_html( $start_time . ( $end_time ? ' - ' . $end_time : '' ) ); ?></strong>
						</div>
						<?php endif; ?>

						<div style="display: flex; justify-content: space-between; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px;">
							<span style="color: #64748b;">Online Event:</span>
							<strong style="color: <?php echo $online_event ? '#16a34a' : '#0284c7'; ?>;">
								<?php echo $online_event ? 'Yes (Online)' : 'In-Person'; ?>
							</strong>
						</div>
						...
						<div style="display: flex; justify-content: space-between; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px;">
							...
							<strong><?php echo esc_html( $capacity ); ?> Seats</strong>
						</div>
						<?php endif; ?>
					</div>
					...
					<?php if ( $registration_url ) : ?>
						<div style="margin-top: 20px; padding-top: 16px; border-top: 1px solid #e2e8f0;">
							<a href="<?php echo esc_url( $registration_url ); ?>" target="_blank" rel="noopener" style="display: inline-block; background: #0284c7; color: #ffffff; font-weight: 700; padding: 10px 22px; border-radius: 8px; text-decoration: none;">
								Register for Event →
							</a>
						</div>
					<?php endif; ?>
