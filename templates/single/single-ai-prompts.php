<?php
/**
 * Single Template for AI Prompts.
...
// ACF Fields
$prompt_text     = get_field( 'prompt_text' );
$prompt_category = get_field( 'prompt_category' );
$ai_platform     = get_field( 'ai_platform' );
$difficulty      = get_field( 'difficulty' );
$example_input   = get_field( 'example_input' );
$example_output  = get_field( 'example_output' );
$prompt_tips     = get_field( 'prompt_tips' );
?>
				...
				<div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; margin: 32px 0;">
					...
					<?php if ( $prompt_text ) : ?>
						<div style="margin-top: 20px; padding-top: 16px; border-top: 1px solid #e2e8f0;">
							<div style="font-size: 0.75rem; font-weight: 700; color: #2563eb; text-transform: uppercase; margin-bottom: 8px;">
								PROMPT TEMPLATE
							</div>
							<pre style="background: #0f172a; color: #f8fafc; padding: 16px; border-radius: 8px; font-family: monospace; font-size: 0.9rem; white-space: pre-wrap; word-break: break-word;"><?php echo esc_html( $prompt_text ); ?></pre>
						</div>
					<?php endif; ?>
				</div>
